...
# def get_mevc(estimated_quality, step, profile_2, config):
#     origin_class = utils.digitize(estimated_quality, config['solution_quality_class_bounds'])
#     origin_quality = utils.get_bin_value(origin_class, config['solution_quality_class_count'])

#     current_intrinsic_value = get_intrinsic_values(origin_quality, config['intrinsic_value_multiplier'])
#     current_time_cost = get_time_costs(step, config['time_cost_multiplier'])
...
#         next_time_cost = get_time_costs(step + 1, config['time_cost_multiplier'])
#         next_comprehensive_value = get_comprehensive_values(intrinsic_value, next_time_cost)
#         next_expected_value += profile_2[origin_class][step][target_class] * next_comprehensive_value

#     return next_expected_value - current_comprehensive_value
